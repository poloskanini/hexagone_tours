  ...
  return (
    <section className="relative scroll-mt-32 bg-white py-24 md:py-32 lg:py-30" id="qui-sommes-nous">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ul role="list" className="grid grid-cols-1 gap-y-12 gap-x-1 sm:grid-cols-2 lg:grid-cols-4">
          {people.map((person, index) => (
            <li key={person.name} className="mx-auto text-center">
              ...
              <div className="mt-3 space-y-1 text-sm text-gray-700">
                <p className="flex items-center justify-center gap-2 font-playfair font-light">
